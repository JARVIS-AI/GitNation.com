...
function rotateLast() {
  if ( rowsInSection % 2 === 0 ) {
    $('.smiles__row:nth-child('+ (rowsInSection - 2) + ') .smiles__img:nth-child('+ (smilesInRow - 2) +')').setAttribute('transform', 'rotate(-90)');
  } else {
    $('.smiles__row:nth-child('+ (rowsInSection - 2) + ') .smiles__img:nth-child('+ (smilesInRow - 1) +')').setAttribute('transform', 'rotate(-90)');
  }
}
